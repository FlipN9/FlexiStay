...
@Component
public class JwtFilter extends OncePerRequestFilter { // 仅仅是用来Authorization的Filter, OncePerRequest意味着这个Filter只执行一次
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse, FilterChain filterChain) throws ServletException, IOException {
        ...
        if (jwt != null && jwtUtil.validateToken(jwt) && SecurityContextHolder.getContext().getAuthentication() == null) { // SecurityContextHolder不包含context表明该user未被验证过
